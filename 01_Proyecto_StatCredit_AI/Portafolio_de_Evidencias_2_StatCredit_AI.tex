...
\subsection{El Problema de Forma Sencilla}
...
\subsection{¿A quiénes vamos a entrevistar y por qué?}
...
\subsection{Preguntas Clave para las Entrevistas}

\subsubsection{1. Sobre los Datos}
...
\subsubsection{2. Sobre los Modelos y la Tecnología}
\begin{itemize}[leftmargin=*]
...
\subsubsection{3. Sobre la Cultura del Banco}
\begin{itemize}[leftmargin=*]
...
\subsubsection{4. Sobre las Reglas y la Regulación}
\begin{itemize}[leftmargin=*]
...
\subsection{¿Qué hacemos con las respuestas?}
