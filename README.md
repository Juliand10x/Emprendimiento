# Repositorio Oficial del Proyecto StatCredit AI
## Curso de Emprendimiento — Pregrado en Ciencia de Datos
**Universidad Externado de Colombia | Semestre 2026-II**

---

## 🚀 Sobre el Proyecto: StatCredit AI

**StatCredit AI** es un motor de scoring crediticio alternativo en modelo **Software as a Service (SaaS B2B)** impulsado por algoritmos no lineales de **Inteligencia Artificial Explicable (XAI)** e **Inferencia Causal**. 

Nuestra solución permite a entidades financieras, neobancos, fintechs y cooperativas evaluar la capacidad real de repago de trabajadores independientes solventes y micronegocios en Colombia que operan en la economía informal y semi-informal urbana, transformando su actividad transaccional en billeteras digitales (Nequi, Daviplata) y facturación electrónica en métricas de riesgo auditables ante la Superintendencia Financiera (SARC - Circular 026).
...
| :--- | :--- | :--- |
| **Santiago Sandoval** | Científico de Datos Lead / ML Architect | Algoritmos de inferencia causal, MLOps y métricas de riesgo. |
| **Sebastián Ramos** | Director de Estrategia \& Negocios B2B | Modelo de monetización SaaS, unit economics y TAM/SAM/SOM. |
| **Julián Duarte** | Data Engineer / Backend Architect | Ingesta de datos transaccionales y arquitectura REST API. |
| **Tomás Rincón** | Analista de Riesgo \& Compliance SARC | Auditoría algorítmica, regulación SARC y explicabilidad SHAP. |
| **Julián Jiménez** | Software Engineer / QA | Calidad de código, integración de módulos y pruebas de latencia. |

---

## 📂 Estructura General del Repositorio

El repositorio está organizado en carpetas numeradas para facilitar la navegación y auditoría académica:
...
- 📊 **Diagnóstico Estratégico (Taller 3):** [Taller_3_Feedback_y_Presentacion_de_la_Idea.tex](file://wsl.localhost/Ubuntu/home/julianxd/code/Emprendimiento/01_Proyecto_StatCredit_AI/01_Talleres_y_Contratos/Taller_3_Feedback_y_Presentacion_de_la_Idea.tex)

---

## 🛠️ Estándar Técnico de Compilación
Todos los documentos fuente `.tex` de la carpeta `02_Portafolios_de_Evidencias/Portafolio_2/` están configurados para compilar mediante `pdflatex` o `xelatex` con codificación UTF-8 y soporte completo en español.
